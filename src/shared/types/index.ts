...
const translations: Record<string, Record<Lang, string>> = {
  ...
  resetPasswordHint: { en: 'Send a request to the server admin to reset your password', ru: 'Отправьте запрос админу сервера для сброса пароля' },
  resetPasswordSuccess: { en: 'Reset code sent! Check your email.', ru: 'Код отправлен! Проверьте почту.' },
  resetPasswordSentToAdmin: { en: 'Request sent to admin. They will contact you in chat.', ru: 'Запрос отправлен админу. Он свяжется с вами в чате.' },
  enterResetCode: { en: 'Enter reset code', ru: 'Введите код сброса' },
  newPasswordPlaceholder: { en: 'New password', ru: 'Новый пароль' },
  resetPassword: { en: 'Send Request', ru: 'Отправить запрос' },
